var getDataFeeds = function() {'use strict';
/*
...
Datafeeds.QuotesPulseUpdater.prototype._updateQuotes = function(symbolsGetter) {
	...
	return Datafeeds;};if (typeof module !== "undefined" && module["exports"]) {	module["exports"] = getDataFeeds;} else if(typeof window !== "undefined") {	window.getDataFeeds = getDataFeeds;}